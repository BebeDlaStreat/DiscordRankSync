...
public class DiscordPapi {
    ...
    public void init() {
        ...
        new PapiUpdateTask(DiscordCommon.getInstance()).runTaskTimerAsynchronously(DiscordSyncSpigot.getInstance(), DiscordCommon.getInstance().getPapiDelay()*20L, DiscordCommon.getInstance().getPapiDelay()*20L);
    }
}
